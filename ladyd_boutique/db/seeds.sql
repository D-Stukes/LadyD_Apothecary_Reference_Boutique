...
VALUES
  ...
  ('Chamomile bar', 'Calming aromatherapy', 5.00, 1, 'images/herbal-bouquet.jpg'),
  ('Shea Butter bar', 'Moisturizes and conditions skin', 3.00, 1, 'images/herbal-bouquet.jpg'),
  ('Cayenne Pepper', 'Increases metabolism', 2.00,  3, 'images/herbal-bouquet.jpg'),
  ('Clove Oil', 'Antiseptic and aromatic', 11.99, 2, 'images/herbal-bouquet.jpg'),
  ('Raw Cacao Powder','Provides excellent circulation support', 18.00, 3, 'images/herbal-bouquet.jpg'),
  ('Maca Powder', 'Balances hormones', 13.00, 3, '/images/herbal-bouquet.jpg'),
  ('Raw vitamin C', 'Supplies the body with antioxidants and fights cellular rusting', 25.00, 4, '/images/herbal-bouquet.jpg'),
  ('Probiotics', 'Restores good bacteria in gut', 30.00, 4, '/images/healingfoods.jpg'),
  ('Ubiquinol', 'Supports a healthy heart', 15.00, 4, '/images/herbal-bouquet.jpg');
